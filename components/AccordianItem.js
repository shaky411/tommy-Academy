...
export default function AccordianItem({open, toggle, title, desc}) {
    return (
        <div className="pt-[10px]">
            <div className="bg-white text-slate-800 py-[25px] px-[50px] flex justify-between items-center cursor-pointer" onClick={toggle}>
            ...
            <Collapse isOpened={open}>
                <div className="bg-white text-slate-500 px-[50px] pb-[20px]">{desc}</div>
            </Collapse>
        </div>
    )
}